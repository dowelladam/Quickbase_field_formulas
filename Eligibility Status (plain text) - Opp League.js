...
var text currentTerm = If(
  Month(Today())=7 or Month(Today())=8 or Month(Today())=9 or Month(Today())=10 or Month(Today())=11 and Day(Today())<=28, "Term 4",
  Month(Today())=11 and Day(Today())>=29 or Month(Today())=12 or Month(Today())=1 or Month(Today())=2 and Day(Today())<=8, "Term 1",
